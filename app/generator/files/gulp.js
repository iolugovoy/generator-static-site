...
var gulpFiles = function gulpFiles() {
  if (this.jsPreprocessor === 'none') {
    ...
    this.template('gulp/es5/stylelint.js', 'gulp/stylelint.js');
    this.template('gulp/es5/imagemin.js', 'gulp/imagemin.js');
    this.template('gulp/es5/watch.js', 'gulp/watch.js');
    this.template('gulp/es5/lighthouse.js', 'gulp/lighthouse.js');
    ...
    if (this.concatOldScripts === 'yes') {
      this.template('gulp/es5/concatLegacyScripts.js', 'gulp/concatLegacyScripts.js');
    }
  }
  else {
    ...
    this.template('gulp/es6/stylelint.js', 'gulp/stylelint.js');
    this.template('gulp/es6/imagemin.js', 'gulp/imagemin.js');
    this.template('gulp/es6/watch.js', 'gulp/watch.js');
    this.template('gulp/es6/lighthouse.js', 'gulp/lighthouse.js');
    ...
    if (this.concatOldScripts === 'yes') {
      this.template('gulp/es6/concatLegacyScripts.js', 'gulp/concatLegacyScripts.js');
    }
  }
};
